...
HD_PWD='D:/HK251/LogicDesignProject/VivadoProject/ProjectAssignment/ProjectAssignment.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log SystemProject.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SystemProject.tcl -notrace
