...
HD_PWD='D:/HK251/LogicDesignProject/VivadoProject/ProjectAssignment/ProjectAssignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemProject.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemProject.tcl
