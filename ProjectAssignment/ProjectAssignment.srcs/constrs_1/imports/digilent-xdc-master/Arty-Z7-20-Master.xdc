...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { clk100 }];#set
...
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { uart_txd }]; #IO_L1P_T0_34 Sch=JB2_P (Pin 3)
